...
# Configuration
BASE_DIR = Path('/SCRATCH/users/monleon-de-la-jan/MCNPy_LIB/JEFF40_LEG_ALL/ace/600/26056')
ORIGINAL_ACE = '/soft_snc/lib/ace/40/600/260560_40.06c'
OUTPUT_DIR = Path('/SCRATCH/users/monleon-de-la-jan/MCNPy_LIB/JEFF40_LEG_ALL/figures')
...
ace_original = mcnpy.read_ace(ORIGINAL_ACE)
...
for group_idx in range(0, TOTAL_SAMPLES, SAMPLES_PER_FIGURE):
    ...
    for sample_idx in range(group_idx + 1, group_end + 1):
        ...
        try:
            ...
            ace_perturbed = mcnpy.read_ace(str(ace_file_path))
