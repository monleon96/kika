...
## Overview
This document summarizes the completion of union grids and boundary check improvements to the ENDF perturbation system in KIKA.
...
- `kika/cov/mf34_covmat.py`: Enhanced union grids and validation
- `kika/sampling/endf_perturbation.py`: Tolerant boundary checks and union grid usage
