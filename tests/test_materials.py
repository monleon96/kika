...
from mcnpy.input.material import Material
...
def test_material_parsing():
    ...
    try:
        ...
        m100 = materials.mat[100000]
        m200 = materials.mat[200100]
        m300 = materials.mat[300000]

        assert m100.libs.get("nlib") == '06c'
        assert m300.libs.get("nlib") == '06c'
        assert m300.libs.get("plib") == '02p'
        assert m100.libs.get("plib") is None
        assert m300.id == 300000
        assert m300.nuclide[6013].libs.get("nlib") == '03c'
        assert m300.nuclide[6013].libs.get("plib") == '04p'
        assert m300.nuclide[6013].zaid == 6013
        assert m300.nuclide[6013].element == 'C'
        assert m300.nuclide[6013].fraction == pytest.approx(0.0001022318)
        assert m300.nuclide[26056].fraction == pytest.approx(0.8810613)
        assert m300.nuclide[24054].fraction == pytest.approx(6.288632e-05)
        assert m300.fraction_type == "ao"

        m200.to_weight_fraction()
        m300.to_weight_fraction()

        assert m300.fraction_type == "wo"
        assert m300.nuclide[6013].fraction == pytest.approx(2.397746932859688e-05)
        assert m300.nuclide[26056].fraction == pytest.approx(0.8888964955001305)
        assert m300.nuclide[24054].fraction == pytest.approx(6.118148592568498e-05)

        assert m200.__str__() == 'm200100 nlib=06c\n\t1001 -1.119138e-01\n\t8016 -8.880762e-01\n\t5010 -1.843705e-06\n\t5011 -8.159614e-06'
        assert m300.__str__() == 'm300000 nlib=06c plib=02p\n\t6012 -1.975285e-03\n\t6013.03c -2.397747e-05\n\t6013.04p -2.397747e-05\n\t23050 -2.450280e-07\n\t23051 -9.971736e-05\n\t24050 -1.044235e-04\n\t24052 -2.091728e-03\n\t24053 -2.417237e-04\n\t24054 -6.118149e-05\n\t28058 -4.379269e-03\n\t28060 -1.731118e-03\n\t28061 -7.619993e-05\n\t28062 -2.460485e-04\n\t28064 -6.438272e-05\n\t42092 -7.086237e-04\n\t42094 -4.549656e-04\n\t42095 -7.861329e-04\n\t42096 -8.343767e-04\n\t42097 -4.846495e-04\n\t42098 -1.229221e-03\n\t42100 -4.996605e-04\n\t14028 -1.836737e-03\n\t14029 -9.632479e-05\n\t14030 -6.614224e-05\n\t25055 -1.349491e-02\n\t15031 -7.996991e-05\n\t16032 -7.577877e-05\n\t16033 -6.168259e-07\n\t16034 -3.567079e-06\n\t16036 -1.525164e-08\n\t29063 -5.480232e-04\n\t29065 -2.516629e-04\n\t27059 -2.998871e-04\n\t26054 -5.415784e-02\n\t26056 -8.888965e-01\n\t26057 -2.119071e-02\n\t26058 -2.908379e-03'

        m200.to_atomic_fraction()
        m300.to_atomic_fraction()

        assert m300.fraction_type == "ao"
        assert m300.nuclide[6013].fraction == pytest.approx(0.00010223180430777937)
        assert m300.nuclide[26056].fraction == pytest.approx(0.8810613371256076)
        assert m300.nuclide[24054].fraction == pytest.approx(6.288632264986424e-05)
        ...
        assert m100.libs.get("nlib") == '06c'
        assert m300.libs.get("nlib") == '06c'
        assert m300.libs.get("plib") is None
        assert m100.libs.get("plib") is None
        assert m300.id == 300000
        assert m300.nuclide[6013].libs.get("nlib") is None
        assert m300.nuclide[6013].libs.get("plib") is None
        assert m300.nuclide[6013].zaid == 6013
        assert m300.nuclide[6013].element == 'C'
        assert m300.nuclide[6013].fraction == pytest.approx(0.0001022318)
        assert m300.nuclide[26056].fraction == pytest.approx(0.8810613)
        ...
        assert m200.__str__() == 'm200100 nlib=06c\n\t1001 -1.119138e-01\n\t8016 -8.880762e-01\n\t5010 -1.843705e-06\n\t5011 -8.159614e-06'
        assert m300.__str__() == 'm300000 nlib=06c\n\t6012 -1.975285e-03\n\t6013 -2.397747e-05\n\t23050 -2.450280e-07\n\t23051 -9.971736e-05\n\t24050 -1.044235e-04\n\t24052 -2.091728e-03\n\t24053 -2.417237e-04\n\t24054 -6.118149e-05\n\t28058 -4.379269e-03\n\t28060 -1.731118e-03\n\t28061 -7.619993e-05\n\t28062 -2.460485e-04\n\t28064 -6.438272e-05\n\t42092 -7.086237e-04\n\t42094 -4.549656e-04\n\t42095 -7.861329e-04\n\t42096 -8.343767e-04\n\t42097 -4.846495e-04\n\t42098 -1.229221e-03\n\t42100 -4.996605e-04\n\t14028 -1.836737e-03\n\t14029 -9.632479e-05\n\t14030 -6.614224e-05\n\t25055 -1.349491e-02\n\t15031 -7.996991e-05\n\t16032 -7.577877e-05\n\t16033 -6.168259e-07\n\t16034 -3.567079e-06\n\t16036 -1.525164e-08\n\t29063 -5.480232e-04\n\t29065 -2.516629e-04\n\t27059 -2.998871e-04\n\t26054 -5.415784e-02\n\t26056 -8.888965e-01\n\t26057 -2.119071e-02\n\t26058 -2.908379e-03'
...
def test_one_line_material_parsing():
    ...
    assert mat_obj.fraction_type == "ao"
    ...
    assert len(mat_obj.nuclide) == 2
    assert mat_obj.fraction_type == "wo"
    assert mat_obj.nuclide[1001].fraction == pytest.approx(0.112)
    assert mat_obj.nuclide[8016].fraction == pytest.approx(0.888)
    ...
    assert mat_obj.libs["nlib"] == "70c"
    assert mat_obj.libs["plib"] == "12p"
    assert len(mat_obj.nuclide) == 2
...
def test_natural_element_conversion():
    ...
    mat = Material(id=901, fraction_type="wo")
    ...
    # Verify we kept weight fraction interpretation
    ...
    # Convert only carbon
    mat.expand_natural_elements(zaid_to_expand=6000)
    ...
    try:
        mat.expand_natural_elements(zaid_to_expand=8016)
...
def test_fraction_conversion_with_natural_elements():
    ...
    # Verify weight fractions interpretation
    assert mat.fraction_type == "wo"
    ...
    # Verify weight fraction interpretation
    assert expanded_mat.fraction_type == "wo"
    
    # Calculate total weight fraction by element after expansion
    c_weight_sum = sum(nuclide.fraction for zaid, nuclide in expanded_mat.nuclide.items() 
                     if zaid // 1000 == 6)
    fe_weight_sum = sum(nuclide.fraction for zaid, nuclide in expanded_mat.nuclide.items() 
                      if zaid // 1000 == 26)
